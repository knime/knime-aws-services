...
/**
 * Settings for operations that work on a DynamoDB table.
 * @author Alexander Fillbrunn, University of Konstanz
 */
public class DynamoDBTableSettings extends DynamoDBSettings {

    /**
     * Config key for the table name.
     */
    // Public so the setting can be overwritten using a flow variable model
