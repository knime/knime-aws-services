...
/**
 * Settings for the DynamoDB List Tables node.
 * @author Alexander Fillbrunn, University of Konstanz
 *
 */
final class DynamoDBListTablesSettings extends DynamoDBSettings {
    
    private static final String CFG_LIMIT = "limit";
    
    /**
     * Value that means unlimited tables are retrieved.
     */
    ...
    /**
     * @return limit the maximum number of tables to retrieve
     */
    int getLimit() {
        return m_limit;
    }
    ...
    /**
     * @param limit the maximum number of tables to retrieve
     */
