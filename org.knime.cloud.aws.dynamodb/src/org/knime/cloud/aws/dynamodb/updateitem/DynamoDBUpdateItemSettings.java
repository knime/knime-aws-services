...
/**
 * Settings for the DynamoDB Update Item node.
 * @author Alexander Fillbrunn, University of Konstanz
 *
 */
public class DynamoDBUpdateItemSettings extends DynamoDBWriterSettings {
    
    private static final String CFG_CONDITION_EXPRESSION = "conditionExpression";
    private static final String CFG_UPDATE_EXPRESSION = "updateExpression";
    ...
    private String m_updateExpression = "";
    private ReturnValue m_returnValue = ReturnValue.NONE;
    
    /**
     * @return an expression describing which conditions have to be met for the item to be updated
     */
    ...
    /**
     * @param conditionExpression an expression describing which conditions have to be met for the item to be updated
     */
    ...
    /**
     * @return an expression describing the update on the item
     */
    ...
    /**
     * @param updateExpression an expression describing the update on the item
     */
    ...
    /**
     * @param returnValue which values to return after the update
     */
    public void setReturnValue(final ReturnValue returnValue) {
     ...
     */
    public DynamoDBPlaceholderSettings getPlaceholders() {
        return m_placeholders;
    }
    
    /**
     * @return settings indicating which columns are used as keys when updating items
     */
    public DynamoDBKeyColumnsSettings getKeyColumns() {
        return m_keyColumns;
    }
    ...
    public void saveSettings(final NodeSettingsWO settings) {
        ...
        settings.addString(CFG_UPDATE_EXPRESSION, m_updateExpression);
    ...
    public void loadSettings(final NodeSettingsRO settings) throws InvalidSettingsException {
        ...
        m_updateExpression = settings.getString(CFG_UPDATE_EXPRESSION);
